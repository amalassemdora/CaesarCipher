 ...
 * @author ncm
 */
public class CaesarCipherForm extends javax.swing.JFrame {

    /**
     * Creates new form CaesarCipherForm
     */
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cipher, javax.swing.GroupLayout.DEFAULT_SIZE, 208, Short.MAX_VALUE)
                            .addComponent(key)
                            .addComponent(plain))
    ...
    private void decryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_decryptActionPerformed
        ...
        try {
            ...
            k = Integer.parseInt(key.getText()) % 26;
        } catch (Exception e) {
        ...
        if (!(plain.getText().equals(""))) {
            f = CaesarCipher.decrypt(plain.getText(), k);
            cipher.setText(f);
        } else {
    ...
    private void encryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_encryptActionPerformed
        ...
        if (!(plain.getText().equals(""))) {
            f = CaesarCipher.encrypt(plain.getText(), k);
            cipher.setText(f);
        } else {
            JOptionPane.showMessageDialog(null, "Enter the text please!", "Error", JOptionPane.ERROR_MESSAGE);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CaesarCipherForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CaesarCipherForm().setVisible(true);
            }
        });
    }
